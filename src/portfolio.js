...
const seo = {
  ...
  description:
    "Committed to pushing the boundaries of innovation and embracing continuous learning in the ever-evolving technology landscape. Enthusiastic about deep learning and quantum computing with a drive for staying at the forefront of advancements in these fields",
  og: {
...
const greeting = {
  ...
  subTitle:
    "Committed to pushing the boundaries of innovation and embracing continuous learning in the ever-evolving technology landscape. Enthusiastic about deep learning and quantum computing with a drive for staying at the forefront of advancements in these fields",
  resumeLink:
    "https://drive.google.com/file/d/1IXyg8Ou8cXOa852_siFy2KVltsrPapgq/view?usp=sharing",
  ...
  data: [
    ...
    },
    {
      ...
      skills: [
        ...
        "⚡ Actively engaged in the IBM Qiskit Summer School to deepen my understanding and practical insights in the field",
      ],
      softwareSkills: [
        {
          skillName: "Qiskit",
